...
Devise.setup do |config|
  ...
  # config.secret_key = '893a230c78e6f6ffb7c2230857927577cc0cdff07dcc0c0d29e66df04dd6556cd44fec7b7f100e54b197d7a82939fc6f42cb16567c496477a3f12366f2d0efd8'
  ...
  config.mailer_sender = 'csis@somedomain.net'
  ...
  # rubocop:disable Metrics/LineLength
  # config.pepper = 'b4d03a521cf220cc9f0c64c6f8e666d2d55c6392b4c31687d8a1bea41058f1884c02ec1ff2d9bbfb494939f90b52853c7aa0ee779318a179cac1e710db5e35d4'
  # rubocop:enable Metrics/LineLength
  ...
  options = ENV['RAILS_ENV'] == 'development' ? {skip_jwt: true} : {}
  ...
  config.omniauth :azure_oauth2,
    ...
    tenant_id:     Rails.application.credentials.dig(:azure, :tenant_id),
    name: 'azure_oauth2',
  ...
  config.allowed_otp_drift_seconds = 10  # Allowed TOTP time drift between client and server.
