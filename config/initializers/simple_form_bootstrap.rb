...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_boolean, tag: 'fieldset', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :form_check_wrapper, tag: 'div', class: 'form-check d-flex align-items-center' do |bb|
      bb.use :input, class: 'form-check-input me-2', error_class: 'is-invalid', valid_class: 'is-valid'
  ...
  # horizontal inputs for radio buttons
  config.wrappers :collection_radio, item_wrapper_class: 'form-check', tag: 'fieldset', class: 'form-group d-flex', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :input, class: 'form-check-input', error_class: 'is-invalid', valid_class: 'is-valid'
    b.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback d-block' }
  ...
  config.wrappers :vertical_vm_occurrence_collection, item_wrapper_tag: nil, tag: 'fieldset',
                  class: 'form-group d-flex flex-column justify-content-start w-100', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: 'legend', class: 'col-form-label pt-0' do |ba|
      ba.use :label_text
    end
    b.use :input, class: 'd-none form-check-input', error_class: 'is-invalid', valid_class: ''
    b.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback d-block' }
    b.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end

  config.wrappers :vertical_wa_occurrence_collection, item_wrapper_tag: nil, tag: 'fieldset',
                  class: 'form-group d-flex flex-column justify-content-start w-100', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: 'legend', class: 'col-form-label pt-0' do |ba|
  ...
  config.wrappers :vertical_file, tag: 'div', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    ...
    b.wrapper tag: 'div', class: 'd-flex flex-column' do |ba|
      ba.use :label
      ba.use :input, class: 'form-control-file', error_class: 'is-invalid', valid_class: 'is-valid'
    end
    b.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback d-block' }
    b.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end
  ...
  config.wrappers :vertical_multi_select, tag: 'div', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper tag: 'div', class: 'd-flex flex-row-reverse justify-content-between align-items-center' do |ba|
      ba.use :input, class: 'form-control mx-1', error_class: 'is-invalid', valid_class: 'is-valid'
      ba.use :label, class: 'form-control-label'
    end
    b.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback d-block' }
    b.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end
  ...
  config.wrappers :custom_multi_select, tag: 'div', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    ...
    b.wrapper tag: 'div', class: 'd-flex flex-row justify-content-between align-items-center' do |ba|
      # ba.use :label, class: 'form-control-label'
      ba.use :input, class: 'form-control selectpicker show-tick mx-1', error_class: 'is-invalid', valid_class: 'is-valid'
    end
    b.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback d-block' }
    b.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end
  ...
  config.wrapper_mappings = {
    ...
    file:          :custom_file,
    radio_buttons: :collection_radio,
    range:         :vertical_range,
    time:          :vertical_multi_select,
    vm_occurrence:  :vertical_vm_occurrence_collection,
    wa_occurrence:  :vertical_wa_occurrence_collection,
